            ...
            <div class="modal-content">
                ...
                <form method="POST" action="{{route('salones.store')}}">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="Submit" class="btn btn-primary">Añadir Salon</button>
                    ...
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 text-right">
                                <a href="" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" >Agregar Salones</a>
                            </div>
                        </div>
                    ...
                    <div class="table-responsive">
                        <table class="table align-items-center table-flush">
                            ...
                            @foreach($salones as $salon)
                                    ...
                                    <td class="text-center">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                ...
                                                <a class="dropdown-item"  data-toggle="modal" data-target="#edit-modal-{{$salon->id}}">Editar</a>
                                ...
                                <div class="modal fade" id="edit-modal-{{$salon->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                            ...
                                            <form method="POST" action="{{route('salones.update', $salon->id)}}">
                                                ...
                                                <div class="modal-body">
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">Nombre</label>
                                                        <input value="{{$salon->nombre}}" name="nombre" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nombre">
                                                    </div>
